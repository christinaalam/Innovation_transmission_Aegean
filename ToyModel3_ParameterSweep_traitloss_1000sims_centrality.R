...
##capture.output(simulation_list, file = "toy3loss1000simsk0.5a1n20or0.01.csv")
...
##calculate node degree 08/02/SUCCESS!!
...
pdf("toy31000simulations.pdf", width = 10, height = 7, paper = "USr")
