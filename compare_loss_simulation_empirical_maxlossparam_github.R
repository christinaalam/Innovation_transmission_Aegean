...
for (a in 1:length(alpha)){
  ...
  nran <- rbind(nran00, all[7]) ##add topleft origin point, which will be the last element of nran
...
##Function that fits SSlogis 28/5/2022
...
##pdf("sweep30012023_scaling_loss_n2000_seed1_eastorigin_narrowkappa.pdf")
...
pdf("sweep02062022_compare_meanmcempir_simulated2.pdf")
...
pdf("variableloss_may2023_compare_meanmcempir_scaling_loss_n2000_seed1_eastorigin_k0.4a1.pdf")
